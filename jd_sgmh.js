...
//助力码 添加自己的 运行一次就可以全部得到
const inviteCodes = [
  'T0205KkcOmtaqSa0VmKAzpBVCjVQmoaT5kRrbA@T0225KkcREwbpFXRchjwlKFedACjVQmoaT5kRrbA@T0225KkcRBxI9wDech7xxaEIdwCjVQmoaT5kRrbA@T018v_52Rhcd9VfTJxyb1ACjVQmoaT5kRrbA@T0225KkcR0gYp1zTJknxwKFYcQCjVQmoaT5kRrbA@T0205KkcIGJjsDayZU-S7IZWCjVQmoaT5kRrbA',
  'T0114rQlQRwapAYCjVQmoaT5kRrbA@T0205KkcFVh_oi6GamGq8pJtCjVQmoaT5kRrbA@T023v_10RBYd8VHTKQfwk_MJd_QCjVQmoaT5kRrbA@T0225KkcRhoY8QHRIR33x6UKJgCjVQmoaT5kRrbA'
];

//const ZLC = !(process.env.JD_JOIN_ZLC && process.env.JD_JOIN_ZLC === 'false')
const ZLC = false
console.log('环境变量' +process.env.JD_JOIN_ZLC )
